...
public class ProjectRepositoryImpl implements ProjectRepositoryCustom{
    ...
    public static final String COMPLETION_DATE_FROM = "completionDateFrom";
    public static final String COMPLETION_DATE_TO   = "completionDateTo";
    ...
    private Query buildQuery(Map<String, Object> filterFields, Map<String, Object> sortFields){
        ...
        if (filterFields.containsKey(NAME) && filterFields.get(NAME)!=""){
            predicates.add(cb.like(cb.lower(projectRoot.get("name")), ("%" + filterFields.get(NAME)+ "%").toLowerCase()));
        }
        ...
        if (filterFields.containsKey(START_DATE_TO) && filterFields.get(START_DATE_TO)!=""){
            predicates.add(cb.lessThanOrEqualTo(projectRoot.get("startDate"),
                    Utils.fromStringToDate((String) filterFields.get(START_DATE_TO))));
        }

        if (filterFields.containsKey(COMPLETION_DATE_FROM)&& filterFields.get(COMPLETION_DATE_FROM)!=""){
            predicates.add(cb.greaterThanOrEqualTo(projectRoot.get("comletionDate"),
                    Utils.fromStringToDate((String) filterFields.get(COMPLETION_DATE_FROM))));
        }
        if (filterFields.containsKey(COMPLETION_DATE_TO) && filterFields.get(COMPLETION_DATE_TO)!=""){
            predicates.add(cb.lessThanOrEqualTo(projectRoot.get("comletionDate"),
                    Utils.fromStringToDate((String) filterFields.get(COMPLETION_DATE_TO))));
        }
